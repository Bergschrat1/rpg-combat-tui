      ...
      let
        ...
        rpg-combat-tui = craneLib.buildPackage (
          ...
          // {
            ...
            version = "0.1.0";
            # version = (craneLib.crateNameFromCargoToml { cargoToml = ./rpg-combat-tui/Cargo.toml; }).version;
        ...
        player-client = craneLib.buildPackage (
          ...
          // {
            pname = "player-client";
            version = "0.1.0";
            # version = (craneLib.crateNameFromCargoToml { cargoToml = ./player-client/Cargo.toml; }).version;
        ...
        shared = craneLib.buildPackage (
          ...
          // {
            pname = "shared";
            version = "0.1.0";
            # version = (craneLib.crateNameFromCargoToml { cargoToml = ./shared/Cargo.toml; }).version;
